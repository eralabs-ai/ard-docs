...
| --- | --- | --- | --- |
| **Claude** | [skill](https://github.com/ardp-project/connectors/tree/main/skills/claude) | [remote MCP](https://github.com/ardp-project/connectors/tree/main/mcp/claude) | Native remote connectors across claude.ai, Desktop, mobile |
