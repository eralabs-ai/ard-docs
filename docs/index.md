...
ARD is an open discovery protocol [GitHub](https://github.com/ards-project/ards-spec) for agentic resources. It allows an AI client to ask: *"What is available for this task?"* and lets a discovery service answer with matching resources.
